...
pt_df = pd.read_csv('../givnu/givnu_csv/givnu_points.csv')
...
df.to_csv('../givnu/givnu_csv/givnu_data.csv', index=False)
...
# 仮想コートの座標
field_template = cv2.imread("../givnu/givnu_video/field_template.jpg")
...
# CSVとして保存
df.to_csv('../givnu/givnu_csv/new_data2.csv', index=False)
