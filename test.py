...
# 使用例
video_path_ori = '../givnu_video/givnu_ori.mp4'
video_path_rslt = '../givnu_video/rslt_givnu.mp4'

output_folder_ori = "../givnu_video/test_frames_ori"  # オリジナル動画の保存先フォルダ
output_folder_rslt = "../givnu_video/test_frames_rslt"  # 結果動画の保存先フォルダ
